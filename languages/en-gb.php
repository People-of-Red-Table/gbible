<?php
	...
	$text['reset_password_exception_vcode'] =  $text['reset_password_exception'] . 'Verification code wasn\t set. ';
	...
	$text['charity_of_your_country'] = 'Charity Organizations of Your Country';
	$text['blacklist'] = 'Black List of Bible Site';
